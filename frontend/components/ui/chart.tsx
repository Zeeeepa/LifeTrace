...
>(
  (
    ...
    const filteredPayload = React.useMemo(() => {
      return payload?.filter(item => item.value && item.value !== 0) || []
    }, [payload])
            ...
            return (
              ...
              >
                    ...
                    <div
                      className={cn(
                        "shrink-0",
                        {
                          ...
                          "w-1 h-full rounded-[2px]": indicator === "line",
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  (() => {
                    const formattedResult = formatter(item.value, item.name, item, index, item.payload);
                    if (Array.isArray(formattedResult)) {
                      const [displayValue, displayLabel] = formattedResult;
                      return (
