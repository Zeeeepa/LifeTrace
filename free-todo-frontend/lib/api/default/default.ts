 ...
 */
export const llmHealthCheckHealthLlmGet = (signal?: AbortSignal) => {
	return customFetcher<unknown>({ url: `/health/llm`, method: "GET", signal });
};

export const getLlmHealthCheckHealthLlmGetQueryKey = () => {
	return [`/health/llm`] as const;
};

export const getLlmHealthCheckHealthLlmGetQueryOptions = <
	TData = Awaited<ReturnType<typeof llmHealthCheckHealthLlmGet>>,
	TError = unknown,
>(options?: {
	query?: Partial<
		UseQueryOptions<
	...
	const queryKey =
		queryOptions?.queryKey ?? getLlmHealthCheckHealthLlmGetQueryKey();

	const queryFn: QueryFunction<
		Awaited<ReturnType<typeof llmHealthCheckHealthLlmGet>>
	> = ({ signal }) => llmHealthCheckHealthLlmGet(signal);
...
export type LlmHealthCheckHealthLlmGetQueryResult = NonNullable<
	Awaited<ReturnType<typeof llmHealthCheckHealthLlmGet>>
>;
export type LlmHealthCheckHealthLlmGetQueryError = unknown;

export function useLlmHealthCheckHealthLlmGet<
	TData = Awaited<ReturnType<typeof llmHealthCheckHealthLlmGet>>,
	TError = unknown,
>(
	options: {
