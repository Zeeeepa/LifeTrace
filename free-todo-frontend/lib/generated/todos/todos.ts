...
export const updateTodoApiTodosTodoIdPut = async (todoId: number,
    todoUpdate: TodoUpdate, options?: RequestInit): Promise<updateTodoApiTodosTodoIdPutResponse> => {
...
export const getUpdateTodoApiTodosTodoIdPutMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTodoApiTodosTodoIdPut>>, TError,{todoId: number;data: TodoUpdate}, TContext>, request?: SecondParameter<typeof customFetcher>}
