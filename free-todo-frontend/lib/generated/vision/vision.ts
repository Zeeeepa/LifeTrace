...
export const visionChatApiVisionChatPost = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/vision/chat`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: visionChatRequest, signal
    },
      );
    }
...
export const getVisionChatApiVisionChatPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof visionChatApiVisionChatPost>>, TError,{data: VisionChatRequest}, TContext>, }
...
export const useVisionChatApiVisionChatPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
      ...
      const mutationOptions = getVisionChatApiVisionChatPostMutationOptions(options);
