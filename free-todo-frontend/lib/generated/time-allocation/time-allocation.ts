...
export const getTimeAllocationApiTimeAllocationGet = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/time-allocation`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getGetTimeAllocationApiTimeAllocationGetQueryOptions = <TData = Awaited<ReturnType<typeof getTimeAllocationApiTimeAllocationGet>>, TError = HTTPValidationError>(params?: GetTimeAllocationApiTimeAllocationGetParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTimeAllocationApiTimeAllocationGet>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTimeAllocationApiTimeAllocationGetQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTimeAllocationApiTimeAllocationGet>>> = ({ signal }) => getTimeAllocationApiTimeAllocationGet(params, signal);
