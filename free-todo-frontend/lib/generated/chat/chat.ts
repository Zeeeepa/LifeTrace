...
export const createNewChatApiChatNewPost = async (newChatRequest: NewChatRequest, options?: RequestInit): Promise<createNewChatApiChatNewPostResponse> => {
...
export const getCreateNewChatApiChatNewPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createNewChatApiChatNewPost>>, TError,{data: NewChatRequest}, TContext>, request?: SecondParameter<typeof customFetcher>}
