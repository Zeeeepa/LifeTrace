...
export const extractTodosFromEventApiTodoExtractionExtractPost = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/todo-extraction/extract`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: todoExtractionRequest, signal
    },
      );
    }
...
export const getExtractTodosFromEventApiTodoExtractionExtractPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof extractTodosFromEventApiTodoExtractionExtractPost>>, TError,{data: TodoExtractionRequest}, TContext>, }
...
export const useExtractTodosFromEventApiTodoExtractionExtractPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
      ...
      const mutationOptions = getExtractTodosFromEventApiTodoExtractionExtractPostMutationOptions(options);
