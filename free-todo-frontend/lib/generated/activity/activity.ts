...
export const getListActivitiesApiActivitiesGetQueryOptions = <TData = Awaited<ReturnType<typeof listActivitiesApiActivitiesGet>>, TError = HTTPValidationError>(params?: ListActivitiesApiActivitiesGetParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listActivitiesApiActivitiesGet>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListActivitiesApiActivitiesGetQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listActivitiesApiActivitiesGet>>> = ({ signal }) => listActivitiesApiActivitiesGet(params, signal);
...
export function useListActivitiesApiActivitiesGet<TData = Awaited<ReturnType<typeof listActivitiesApiActivitiesGet>>, TError = HTTPValidationError>(
 params?: ListActivitiesApiActivitiesGetParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listActivitiesApiActivitiesGet>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List Activities
...
export const getActivityEventsApiActivitiesActivityIdEventsGet = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/activities/${activityId}/events`, method: 'GET', signal
    },
      );
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetActivityEventsApiActivitiesActivityIdEventsGetQueryKey(activityId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getActivityEventsApiActivitiesActivityIdEventsGet>>> = ({ signal }) => getActivityEventsApiActivitiesActivityIdEventsGet(activityId, signal);
...
export const createActivityManualApiActivitiesManualPost = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/activities/manual`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: manualActivityCreateRequest, signal
    },
      );
    }
...
export const getCreateActivityManualApiActivitiesManualPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createActivityManualApiActivitiesManualPost>>, TError,{data: ManualActivityCreateRequest}, TContext>, }
...
export const useCreateActivityManualApiActivitiesManualPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
      ...
      const mutationOptions = getCreateActivityManualApiActivitiesManualPostMutationOptions(options);
