...
export const getScreenshotsApiScreenshotsGet = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/screenshots`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getGetScreenshotsApiScreenshotsGetQueryOptions = <TData = Awaited<ReturnType<typeof getScreenshotsApiScreenshotsGet>>, TError = HTTPValidationError>(params?: GetScreenshotsApiScreenshotsGetParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getScreenshotsApiScreenshotsGet>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetScreenshotsApiScreenshotsGetQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getScreenshotsApiScreenshotsGet>>> = ({ signal }) => getScreenshotsApiScreenshotsGet(params, signal);
...
export const getScreenshotApiScreenshotsScreenshotIdGet = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/screenshots/${screenshotId}`, method: 'GET', signal
    },
      );
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetScreenshotApiScreenshotsScreenshotIdGetQueryKey(screenshotId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getScreenshotApiScreenshotsScreenshotIdGet>>> = ({ signal }) => getScreenshotApiScreenshotsScreenshotIdGet(screenshotId, signal);
...
export const getScreenshotImageApiScreenshotsScreenshotIdImageGet = (
 ...
 signal?: AbortSignal
      ...
      return customFetcher<unknown>(
      {url: `/api/screenshots/${screenshotId}/image`, method: 'GET', signal
    },
      );
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetScreenshotImageApiScreenshotsScreenshotIdImageGetQueryKey(screenshotId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getScreenshotImageApiScreenshotsScreenshotIdImageGet>>> = ({ signal }) => getScreenshotImageApiScreenshotsScreenshotIdImageGet(screenshotId, signal);
...
export const getScreenshotPathApiScreenshotsScreenshotIdPathGet = (
 ...
 signal?: AbortSignal
      ...
      return customFetcher<unknown>(
      {url: `/api/screenshots/${screenshotId}/path`, method: 'GET', signal
    },
      );
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetScreenshotPathApiScreenshotsScreenshotIdPathGetQueryKey(screenshotId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getScreenshotPathApiScreenshotsScreenshotIdPathGet>>> = ({ signal }) => getScreenshotPathApiScreenshotsScreenshotIdPathGet(screenshotId, signal);
